...
public class WhitePawn3D extends Group  implements White{
    private ObjModelImporter objImporter = new ObjModelImporter();
    private HelloController helloController;
    private boolean myTurn = true;

    public WhitePawn3D(HelloController helloController) {
        this.helloController = helloController;
        objImporter.read(getClass().getResource("/whitepawn1.obj")); //ANVÄND whitepawn1.obj
